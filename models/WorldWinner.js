...
var Winner = new keystone.List("WorldWinner");

//Define the fields for the model
Winner.add({
	competition: { 
		type: keystone.Field.Types.Select, noedit: true, index: true, required: true, initial: true, default: "world", options: [
	...
	country: { type: keystone.Field.Types.Text, initial: true, required: true, label: "Representing Country", note: "(The country being represented, not location)" },
});
